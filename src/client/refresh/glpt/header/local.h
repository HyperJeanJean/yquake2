...
#define CHECK_GL_ERROR() { GLuint err = glGetError(); if (err != GL_NO_ERROR) {	R_Printf(PRINT_ALL, "OpenGL Error at " __FILE__ " line " STRINGIFY(__LINE__) ": glGetError() = 0x%x\n", err); } }
